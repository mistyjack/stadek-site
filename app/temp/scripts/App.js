...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.siteHead = (0, _jquery2.default)(".site-header");
        this.headerTriggerElement = (0, _jquery2.default)(".large-al__title");
        this.pageSections = (0, _jquery2.default)(".pg-section");
        ...
        value: function createHeaderWaypoint() {
            ...
            new Waypoint({
                ...
                handler: function handler(direction) {
                    if (direction == "down") {
                        that.siteHead.addClass("site-header--darker");
                    } else {
                        that.siteHead.removeClass("site-header--darker");
                    }
                }
            });
        }
...
var Maps = function () {
    function Maps() {
        ...
        this.maps = (0, _jquery2.default)('.maps');
        this.initMap();
    }
